...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:allCellID];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:allCellID forIndexPath:indexPath];
